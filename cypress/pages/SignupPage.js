class SignupPage {
  go() {
    //pega baseURL do cypress.json
    cy.visit("/");
    cy.get('a[href="/deliver"]').click();
    //checkpoint verificando com o should de que
    //está sendo levado para o caminho correto da pag
    cy.get("#page-deliver form h1").should(
      "have.text",
      //no html tem um espaço a mais, reportar ao dev
